      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center p-4 rounded-lg bg-card">
          ...
          {stats.likesThisWeek > 0 && (
            <Badge variant="secondary" className="mt-2 text-[10px]">+{stats.likesThisWeek} cette semaine</Badge>
          )}
        </div>
        <div className="text-center p-4 rounded-lg bg-card">
          ...
          {stats.viewsThisWeek > 0 && (
            <Badge variant="secondary" className="mt-2 text-[10px]">+{stats.viewsThisWeek} cette semaine</Badge>
          )}
        </div>
        <div className="text-center p-4 rounded-lg bg-card">
          ...
          {stats.newFollowers > 0 && (
            <Badge variant="secondary" className="mt-2 text-[10px]">+{stats.newFollowers} nouveaux</Badge>
          )}
        </div>
      </div>
